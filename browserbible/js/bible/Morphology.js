/** Greek morphology, e.g. "V-PAI-3S" -> "verb: present, active, indicative, 3rd, singular". */
...
/** Hebrew/Aramaic morphology, e.g. "HVqp3ms" -> "verb: qal, perfect (qatal), 3rd, masculine, singular". */
export const OSHB = {
  format(morph) {
