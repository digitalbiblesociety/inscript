...
class AudioWindowComponent extends BaseWindow {
    ...
    this.innerHTML = `
      <div class="audio-window-container">
        ...
        <div class="audio-window-error" style="display: none;">
          ...
          <div class="audio-error-title">${i18nT('windows.audio.noaudiotitle')}</div>
          <div class="audio-error-message">${i18nT('windows.audio.noaudiomessage')}</div>
        </div>
   ...
   * Priority: the active Bible window text, then same language, then English.
   */
